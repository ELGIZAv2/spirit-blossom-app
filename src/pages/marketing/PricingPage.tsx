...
const PLANS: PlanCardConfig[] = [
  ...
  },
  {
    ...
    monthlyPrice: 25,
    yearlyPrice: 250,
    monthlyCredits: "50 MC / month",
    yearlyCredits: "600 MC / year",
    features: [
  ...
  },
  {
    ...
    monthlyPrice: 50,
    yearlyPrice: 500,
    monthlyCredits: "120 MC / month",
    yearlyCredits: "1,440 MC / year",
    features: [
      ...
      "Video generation — credit-based",
      "120 MC for video 1,200 MC for video & extra usage extra usage",
      "Megsy OS — autonomous 24/7 agent",
  ...
  },
  {
    ...
    features: [
      ...
      "Video generation — credit-based",
      "3,50 MC for video 500 MC for video & extra usage extra usage",
      "Megsy OS — autonomous 24/7 agent",
