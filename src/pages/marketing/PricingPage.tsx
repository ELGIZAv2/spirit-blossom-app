...
const PLANS: PlanCardConfig[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Images: unlimited for 7 days each month",
      "Slides & presentations: unlimited 7 days each month",
      "Docs & Deep Research: unlimited 7 days each month",
      "Code builder: unlimited 7 days each month",
      "Video generation — credit-based",
      "100 MC for video & extra usage",
  ...
  },
  {
    ...
    yearlyCredits: "3,000 MC / year",
    features: [
      "Everything in Pro, plus:",
      "Unlimited chat — every premium model",
      "Images: unlimited for 15 days each month",
      "Slides & presentations: unlimited 15 days each month",
      "Docs & Deep Research: unlimited 15 days each month",
      "Code builder: unlimited 15 days each month",
      "Video generation — credit-based",
      "250 MC for video & extra usage",
      "Megsy OS — autonomous 24/7 agent",
